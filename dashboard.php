    ...
    <div class="d-flex flex-column bg-white min-vh-100">
            ...
            <div class="container-fluid  mx-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white fw-bold  text-decoration-underline link-offset-2 fw-bold" href="dashboard.php">
        ...
        <div class="container flex-fill d-flex flex-column my-2">
            ...
            <div class="d-flex mt-5 mb-5 justify-content-center align-items-center">
                <h2 class="text-danger-emphasis link-offset-1 text-decoration-underline flex-grow-1 flex-md-grow-0 text-capitalize">
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="../images/dash.jpg" class="img-fluid flex-fill" style="object-fit: cover;" alt="bg" />
                </div>
            </div>
